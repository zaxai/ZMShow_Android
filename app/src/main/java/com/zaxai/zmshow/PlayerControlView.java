...
public class PlayerControlView extends FrameLayout {
  ...
  public static final int BUTTON_TYPE_PREVIOUS=1;
  public static final int BUTTON_TYPE_FASTFORWARD=2;
  public static final int BUTTON_TYPE_REWIND=3;
  public static final int BUTTON_TYPE_PLAY=4;
  public static final int BUTTON_TYPE_PAUSE=5;
  public static final int BUTTON_TYPE_REPEATTOGGLE=6;
  public static final int BUTTON_TYPE_SHUFFLE=7;
  //ZMShow增加

  /** The default fast forward increment, in milliseconds. */
  public static final int DEFAULT_FAST_FORWARD_MS = 15000;
  /** The default rewind increment, in milliseconds. */
  public static final int DEFAULT_REWIND_MS = 15000;//ZMShow修改
  ...
  private ButtonClickListener buttonClickListener;//ZMShow增加
  ...
  private void previous() {
    ...
    if (previousWindowIndex != C.INDEX_UNSET) {
      seekTo(previousWindowIndex, C.TIME_UNSET);//ZMShow修改
    } else {
      seekTo(0);
    }
  }
  ...
  private final class ComponentListener extends Player.DefaultEventListener
    ...
    public void onClick(View view) {
      if (player != null) {
        if (nextButton == view) {
          if(buttonClickListener!=null)//ZMShow增加
            buttonClickListener.onButtonClick(BUTTON_TYPE_NEXT);//ZMShow增加
          next();
        } else if (previousButton == view) {
          if(buttonClickListener!=null)//ZMShow增加
            buttonClickListener.onButtonClick(BUTTON_TYPE_PREVIOUS);//ZMShow增加
          previous();
        } else if (fastForwardButton == view) {
          if(buttonClickListener!=null)//ZMShow增加
            buttonClickListener.onButtonClick(BUTTON_TYPE_FASTFORWARD);//ZMShow增加
          fastForward();
        } else if (rewindButton == view) {
          if(buttonClickListener!=null)//ZMShow增加
            buttonClickListener.onButtonClick(BUTTON_TYPE_REWIND);//ZMShow增加
          rewind();
        } else if (playButton == view) {
          if(buttonClickListener!=null)//ZMShow增加
            buttonClickListener.onButtonClick(BUTTON_TYPE_PLAY);//ZMShow增加
          ...
          if(buttonClickListener!=null)//ZMShow增加
            buttonClickListener.onButtonClick(BUTTON_TYPE_PAUSE);//ZMShow增加
          controlDispatcher.dispatchSetPlayWhenReady(player, false);
        } else if (repeatToggleButton == view) {
          if(buttonClickListener!=null)//ZMShow增加
            buttonClickListener.onButtonClick(BUTTON_TYPE_REPEATTOGGLE);//ZMShow增加
          ...
          if(buttonClickListener!=null)//ZMShow增加
            buttonClickListener.onButtonClick(BUTTON_TYPE_SHUFFLE);//ZMShow增加
