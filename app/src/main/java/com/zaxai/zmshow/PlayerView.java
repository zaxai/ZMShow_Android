...
public class PlayerView extends FrameLayout {
  ...
  private final PlayerTitleView titleBar; //ZMShow增加
  private VisibilityListener visibilityListener;//ZMShow增加
  ...
  public PlayerView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    //Player title view   //ZMShow增加
    View titlePlaceholder=findViewById(R.id.exo_title_placeholder);
    if(titlePlaceholder!=null){
      titleBar=new PlayerTitleView(context);
      titleBar.setLayoutParams(titlePlaceholder.getLayoutParams());
      ...
      parent.addView(titleBar, titleIndex);
    }else{
      titleBar=null;
    }//ZMShow增加
     ...
     */
    public void setTitleControllerVisibilityListener(VisibilityListener listener) {
  ...
  //ZMShow增加
  public void setControllerButtonClickListener(PlayerControlView.ButtonClickListener listener){
    controller.setButtonClickListener(listener);
  }//ZMShow增加
   ...
   * @param listener The listener to be notified about visibility changes.
   */
  //ZMShow修改 public改private
  private void setControllerVisibilityListener(PlayerControlView.VisibilityListener listener) {
    Assertions.checkState(controller != null);
